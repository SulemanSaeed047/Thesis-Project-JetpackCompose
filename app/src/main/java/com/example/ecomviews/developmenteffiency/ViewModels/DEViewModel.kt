package com.example.ecomviews.developmenteffiency.ViewModels
...
import com.example.ecomviews.developmenteffiency.Reopsitries.ProductsRepo
...
import com.example.ecomviews.developmenteffiency.Reopsitries.AuthRepo
...
class DEViewModel : ViewModel() {
    ...
    fun setTheme(isDark:Boolean,from:String){
        ...
        if(isDark) switchToDarkTheme() else switchToLightTheme()
    }
